...
st.title("Proyecto Modelo ML - GradientBoostRegressor - Christopher Panana - DATAPATH")
...
pipeline_de_produccion = joblib.load('src/precio_casas_pipeline_GBR.joblib') #src/
